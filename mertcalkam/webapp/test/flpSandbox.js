		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MertCalkan JSON",
									"targetURL": "#jsonmertcalkam-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jsonmertcalkam-display": {
								"semanticObject": "jsonmertcalkam",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=json.mertcalkam",
									"url": sap.ui.require.toUrl("json/mertcalkam")
								}
							}
						}
					}
